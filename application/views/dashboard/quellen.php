                    ...
                    <ul class="list-unstyled navbar__list">
						...
						<li class="active">
							<a class="js-arrow" href="<?php echo base_url('dashboard/quellen')?>">
								<i class="fas fa-copy"></i>Quellen</a>
						</li>
                    </ul>
                </nav>
            </div>
            ...
            <div class="table-responsive table--no-card m-b-30">
                <table class="table table-borderless table-striped table-earning">
					...
					<?php foreach($quellenrequests as $quellenrequest): ?>
						<tr>
							<td><?php echo date("d.m.Y", strtotime($quellenrequest['date'])) ?></td>
							<td><?php echo $quellenrequest['name'] ?></td>
							<td><?php echo $quellenrequest['email'] ?></td>
							...
							<?php } ?>
							<td><button type="button" class="btn au-btn--blue" data-toggle="modal" data-target="#my_modal_<?php echo $quellenrequest['id'];?>">Antworten</button></td>
						</tr>
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="exampleModalLabel">API-Key Anfrage #<?php echo $quellenrequest['id']; ?></h5>
