...
<head>
    ...
    <link href="<?php echo base_url(); ?>/slick/slick.css" rel="stylesheet" media="all">
            ...
            <div class="table-responsive table--no-card m-b-30">
                <table class="table table-borderless table-striped table-earning">
					...
					<?php foreach($contactrequests as $contactrequest): ?>
						<tr>
							<td><?php echo date("d.m.Y", strtotime($contactrequest['date'])) ?></td>
							<td><?php echo $contactrequest['name'] ?></td>
							<td><?php echo $contactrequest['email'] ?></td>
							...
							<?php } ?>
							<td><button type="button" class="btn au-btn--blue" data-toggle="modal" data-target="#my_modal_<?php echo $contactrequest['id'];?>">Antworten</button></td>
						</tr>
